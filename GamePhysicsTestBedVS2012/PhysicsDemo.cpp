...
void PhysicsDemo::ShutdownPhysics() {
	...
	CreateGameObject(new btBoxShape(btVector3(1,10,1)), 1.0, btVector3(1.0f, 0.2f, 0.2f), btVector3(0.0f, 10.0f, 0.0f));
	// create a second box
	CreateGameObject(new btBoxShape(btVector3(5,1,1)), 1.0, btVector3(0.0f, 0.2f, 0.8f), btVector3(1.25f, 20.0f, 0.0f));
