...
static GamePhysicsTestBed* g_pApp;
...
// GamePhysicsTestBed object.
int glutmain(int argc, char **argv, int width, int height, const char* title, GamePhysicsTestBed* pApp) {
